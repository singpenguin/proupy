...
class AuthorPage:
    def GET(self,name,id):
        ...
        rand_news = base.get_rand_news()
        config.title = name + '的所有文章'
        return render.result(name,list_news,"123",n,pagecount,
                             base.tag_cache,rand_news)
...
class tag:
    def GET(self,name):
        ...
        return render.result(name,list_news,'',1,pagecount,base.tag_cache,
                             rand_news)
...
class tagPage:
    def GET(self,name,id):
        ...
        rand_news = base.get_rand_news()
        config.title = name + '下面的所有文章'
        return render.result(name,list_news,'',n,pagecount,base.tag_cache,
                             rand_news)
class notFound:
    def GET(self):
