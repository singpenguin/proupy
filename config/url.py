...
urls = (
    ...
    '/news/page/(\d+)',                     pre_fix + 'main.newsPage',
    '/news/cmts',                           pre_fix + 'main.Comments',
    '/news/cmts/page/(\d+)',                pre_fix + 'main.Comments',
    '/author/(.*)/page/(\d+)',              pre_fix + 'main.AuthorPage',
    '/author/(.*)',                         pre_fix + 'main.Author',
    '/tag/(.*)/page/(\d+)',                 pre_fix + 'main.tagPage',
    '/tag/(.*)',                            pre_fix + 'main.tag',
    '/set_ding_cai/(\d+)/(\d+)',            pre_fix + 'main.handlerDingCai',
    ...
    '/login/(.*)',                          pre_fix + 'OAuthLogin.OAuthLogin',
    '/login',                               pre_fix + 'OAuthLogin.LoginHandler',
